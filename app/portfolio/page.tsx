...
import {
  ...
  Bot, User, ChevronRight, Clock, DollarSign, Percent,
...
function ConnectWalletPrompt() {
  ...
  const handleConnect = async () => {
    ...
    // For now, we'll reload to show mock data
...
// ============================================================================
// PORTFOLIO SUMMARY CARDS - Key metrics at the top
// ============================================================================
...
// ============================================================================
// HOLDINGS TABLE - List of all stocks the user owns
// ============================================================================
...
// ============================================================================
// HOLDINGS CARDS - Mobile-friendly card view
// ============================================================================
...
// ============================================================================
// WALLET INFO BAR - Shows connected wallet address
// ============================================================================
...
export default function PortfolioPage() {
  // In a real app, this would come from wallet adapter context
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Holdings Section (2/3 width on desktop) */}
        ...
        {/* Transaction History (1/3 width on desktop) */}
        <div>
